...
[base]
name=CentOS-7 - Base
baseurl=http://10.0.192.12/repos/centos/base
gpgcheck=0
...
baseurl=http://10.0.192.12/repos/centos/updates
gpgcheck=0
gpgkey=file:///etc/pki/rpm-gpg/RPM-GPG-KEY-CentOS-7
...
baseurl=http://10.0.192.12/repos/centos/extras
gpgcheck=0
gpgkey=file:///etc/pki/rpm-gpg/RPM-GPG-KEY-CentOS-7
EOF
...
#baseurl=http://10.0.192.12/repos/epel/
...
baseurl=http://10.0.192.12/repos/openstack-mitaka
